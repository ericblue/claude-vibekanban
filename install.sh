...
echo "  /work-task       - Execute a specific task end-to-end"
echo "  /work-next       - Find the best next task and execute it"
echo ""
echo "Parallel execution (experimental):"
echo "  /work-parallel   - Set up worktrees and launch parallel sessions"
echo "  /merge-parallel  - Merge worktree branches, test, update VK, and clean up"
echo "  /delegate-task   - Delegate a task to a VK workspace session"
echo "  /delegate-parallel - Delegate multiple tasks to parallel VK sessions"
echo "  /session-status  - Check status of all active work (worktrees + VK sessions)"
echo ""
...
echo ""
echo "Help:"
echo "  /workflow        - Show command reference and recommended flow"
echo ""
